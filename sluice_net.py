...
from constants import   IMBALANCED, BALANCED, SGD, ADAM, LABELS, TASK_NAMES
        ...
        for epoch in range(self.best_epoch+1, num_epochs):
            ...
            for lang in train_languages:
                ...
                train_eval_X, train_eval_Y, _ = utils.get_data(
                          [lang], model.task_names, model.word2id,
                ...
                train_score = self.evaluate(train_eval_X, train_eval_Y, lang, args.threshold)


                dev_score = self.evaluate(dev_eval_X, dev_eval_Y, lang, args.threshold)

                avg_train_score_by_task_list.append(utils.average_by_task(train_score))
                avg_dev_score_by_task_list.append(utils.average_by_task(dev_score))
                ...
                utils.log_fit(self.log_dir, epoch+1, train_languages, test_lang, task_names, train_score, dev_score)
            ...
            avg_train_score = util.average_by_lang(avg_train_score_by_task_list, train_data_size_list, 
                total_train_size)

            avg_dev_score = util.average_by_lang(avg_dev_score_by_task_list, dev_data_size_list, 
                total_dev_size)
